                ...
                <div class="mb-8">
                    <label class="block mb-2">
                        <el-form-item label="" prop="password" class="relative w-full" >
                            <el-input v-model="formData.password" placeholder="請輸入密碼" :type="showPassword ? 'text' : 'password'" />
                                <el-icon @click="toggleShowPassword" class="cursor-pointer" style="position: absolute; top: 0; bottom: 0; margin: auto; right: 10px;">
                    ...
                    <label class="block">
                        <el-form-item label="" prop="password_confirmation" class="relative w-full">
                            <el-input v-model="formData.password_confirmation" placeholder="請再次輸入密碼":type="showPasswordConfirm ? 'text' : 'password'" />
                            <el-icon @click="toggleShowPasswordConfirm" class="cursor-pointer" style="position: absolute; top: 0; bottom: 0; margin: auto; right: 10px;">
...
const formRules = reactive({
    password: [
        { required: true, message: "密碼未填寫", trigger: "blur" },
        { min: 8, message: '密碼至少8位', trigger: 'blur' },
        { pattern: /[a-z]/, message: '需含小寫字母', trigger: 'blur' },
        { pattern: /[0-9]/, message: '需含數字', trigger: 'blur' },
